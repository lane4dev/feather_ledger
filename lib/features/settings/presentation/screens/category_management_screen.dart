...
import 'package:feather_ledger/features/settings/presentation/providers/category_providers.dart';
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              leading: CircleAvatar(
                backgroundColor:
                    Color(category.colorInt).withValues(alpha: 0.2),
                foregroundColor: Color(category.colorInt),
                child: Icon(
                    IconData(int.tryParse(category.iconKey) ?? 0xe574,
  ...
  Future<void> _deleteCategory() async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content:
            const Text('This will not delete existing transactions.'), // TODO: l10n
        actions: [
          TextButton(
